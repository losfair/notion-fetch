// https://github.com/remorses/react-notion-x/blob/d023dcdc3103199b828c1065e1d13f2c1c80088d/packages/notion-client/src/notion-api.ts
...
export class NotionAPI {
      ...
      await pMap(
        ...
        async (collectionInstance) => {
          ...
          try {
            ...
            console.warn('NotionAPI collectionQuery error', pageId, (err as any).message)
            console.error(err)
          }
        },
        {
  ...
  public async getCollectionData(
    ...
    if (groupBy) {
      ...
      const reducersQuery: Record<string, unknown> = {}
